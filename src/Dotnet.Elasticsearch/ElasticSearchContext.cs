...
using Dotnet.Elasticsearch.ContentExists;
using Dotnet.Elasticsearch.ContextAddDeleteUpdate;
using Dotnet.Elasticsearch.ContextAddDeleteUpdate.IndexModel;
using Dotnet.Elasticsearch.ContextAddDeleteUpdate.IndexModel.MappingModel;
using Dotnet.Elasticsearch.ContextAddDeleteUpdate.IndexModel.SettingsModel;
using Dotnet.Elasticsearch.ContextAlias;
using Dotnet.Elasticsearch.ContextAlias.AliasModel;
using Dotnet.Elasticsearch.ContextClearCache;
using Dotnet.Elasticsearch.ContextCount;
using Dotnet.Elasticsearch.ContextDeleteByQuery;
using Dotnet.Elasticsearch.ContextGet;
using Dotnet.Elasticsearch.ContextSearch;
using Dotnet.Elasticsearch.ContextSearch.SearchModel;
using Dotnet.Elasticsearch.ContextWarmers;
using Dotnet.Elasticsearch.Model;
using Dotnet.Elasticsearch.Model.SearchModel;
