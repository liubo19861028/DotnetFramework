...
namespace DotCommon.Dapper
{
        ...
        where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        public NHibernateRepositoryBase(IActiveTransactionProvider activeTransactionProvider)
        {
        ...
        {
            get { return (ISession)_activeTransactionProvider.GetActiveTransaction(ActiveTransactionProviderArgs.Empty); }
        }
        ...
        {
            Session.Save(entity);
            TPrimaryKey primaryKey = ISession.Insert<TEntity>(entity, ActiveTransaction);
            return primaryKey;
        }
    }
}
