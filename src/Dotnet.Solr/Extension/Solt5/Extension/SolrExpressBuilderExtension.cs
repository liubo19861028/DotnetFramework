...
using Dotnet.Solr.Solr5.Search;
using Dotnet.Solr.Solr5.Search.Parameter;
using Dotnet.Solr.Solr5.Search.Result;
using Dotnet.Solr.Solr5.Update;
using Dotnet.Solr.Update;

namespace Dotnet.Solr.Solr5.Extension
{
    public static class SolrExpressBuilderExtension
    {
        /// <summary>
        /// Use Dotnet.Solr services implemented in SOLR 5
        /// </summary>
        /// <param name="solrExpressBuilder">Builder to control Dotnet.Solr behavior</param>
        /// <returns>Builder to control Dotnet.Solr behavior</returns>
