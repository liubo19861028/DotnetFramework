...
namespace Dotnet.Webs.Clients {
    ...
    public class HttpRequest : HttpRequestBase<IHttpRequest>, IHttpRequest {
        ...
        /// 获取Json结果
        /// </summary>
        public async Task<TResult> ResultFromJsonAsync<TResult>() where TResult : class
        {
            return _jsonSerializer.Deserialize<TResult>( await ResultAsync() );
        }
    }
