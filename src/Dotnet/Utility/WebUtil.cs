...
namespace Dotnet.Utility
{
    ...
    public static class WebUtil {
       ...
       // public static IHostingEnvironment Environment { get; set; }
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static Dotnet.Webs.Clients.WebClient Client() {
            return new Dotnet.Webs.Clients.WebClient();
        }
        ...
        public static Dotnet.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class {
            return new Dotnet.Webs.Clients.WebClient<TResult>();
        }
